/****************************************************************************
** Meta object code from reading C++ file 'control_window.hpp'
**
...
#error "The header file 'control_window.hpp' doesn't include <QObject>."
...
void Control_Window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->changedIndex((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->setIndex(); break;
        default: ;
        }
    }
}
