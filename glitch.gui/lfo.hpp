...
public:
    ...
    KnobT(const KnobT<T> &type) : value_{type.value_}, speed{type.speed}, min_{type.min_}, max_{type.max_} {}
    KnobT(KnobT<T> &&type) : value_{type.value_}, speed{type.speed}, min_{type.min_}, max_{type.max_} {}
