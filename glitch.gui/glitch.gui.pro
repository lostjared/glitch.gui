...
SOURCES += main.cpp main_window.cpp toolbox_window.cpp display_window.cpp new_image.cpp debug_window.cpp cat_vec.cpp plugin_program.cpp new_filter.cpp filters/filters.cpp filters/colorxor2.cpp filters/frame_collection.cpp filters/trails.cpp filters/glitch.cpp record_window.cpp ffmpeg_write.cpp custom_window.cpp custom_edit.cpp pref_window.cpp mux_window.cpp control_window.cpp rotate_window.cpp layers_window.cpp
